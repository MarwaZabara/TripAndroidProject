...
public class CancelTripPresenter implements ITripPresenter, UpdateTripContract.IUpdateTripPresenter, Reminder.IBaseReminder {

    UpdateTripContract.IUpdateTripModel model;
    Context context;
    public CancelTripPresenter(Context context) {
